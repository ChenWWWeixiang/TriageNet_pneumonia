...
def get_args():
    ...
    parser.add_argument('--model_path', type=str, default='../weights/weak_super.pt',
                        help='Model path')
    parser.add_argument('--output_path', type=str, default='/mnt/data9/covid_detector_jpgs/cam/errorscam',
